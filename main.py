...
def sinprocessor(args: argparse.Namespace, file_dir):
...
def multiprocessor(args: argparse.Namespace, file_dir):
...
if __name__ == "__main__":
    ...
    if not args.multiple_enable:
        sinprocessor(args, file_dir=args.file_dir)
    else:
        multiprocessor(args=args, file_dir=args.file_dir)
